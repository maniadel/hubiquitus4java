...
* TwitterBot allows to retrive data from twitter and post a tweets [README](https://github.com/maniadel/hubiquitus4java/blob/master/Bots/GooglePlusBot/README.md)
