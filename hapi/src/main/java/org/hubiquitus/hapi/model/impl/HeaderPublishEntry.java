 ...
 * @author o.chauvie
 */
public class HeaderPublishEntry implements PublishEntry {

	public static final String HKEY = "hKey";
	public static final String HVALUE = "hValue";
	...
	public String entryToJsonFormat() {
		String divider = ",";
        String json = "{\"" + HKEY + "\":\"" + getHKey() + "\"" + divider;
        json = json + "\"" + HVALUE + "\":\"" + getHValue() + "\"";
        json = json + "}";
    	return json;
	}
