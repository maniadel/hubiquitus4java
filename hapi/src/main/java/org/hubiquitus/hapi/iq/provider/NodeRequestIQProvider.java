 ...
 *
 */
public class NodeRequestIQProvider implements IQProvider {
	...
	private static class PrivateDataResult extends IQ {
	    ...
	    public String getChildElementXML() {
	        ...
	        buf.append("<query xmlns=\"" + NodeRequestEntry.NAMESPACE+ "\">");
	        if (privateData != null) {
    ...
    public IQ parseIQ(XmlPullParser parser) throws Exception {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (parser.getName().equals(NodeRequestEntry.QUERY_ROOT_ELEMENT)) {
                    done = true;
                }
            }
        }
