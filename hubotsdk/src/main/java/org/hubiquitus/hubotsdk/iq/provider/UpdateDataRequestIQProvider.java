...
/**
 * IQ provider for NodeRequestEntry
 * @author o.chauvie
 *
 */
public class UpdateDataRequestIQProvider implements IQProvider {
	...
	private static class PrivateDataResult extends IQ {
	    ...
	    public String getChildElementXML() {
	        ...
	        buf.append("<query xmlns=\"" + UpdateDataRequestEntry.NAMESPACE+ "\">");
	        if (privateData != null) {
    ...
    public IQ parseIQ(XmlPullParser parser) throws Exception {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (parser.getName().equals(UpdateDataRequestEntry.QUERY_ROOT_ELEMENT)) {
                    done = true;
                }
            }
        }
